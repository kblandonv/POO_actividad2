...
public class Triangulo {
    ...
    public double semiperimetro() {
        /* El semiperimetro de un triangulo es: la suma de todos sus lados dividido
        entre 2*/
    ...
    public double area() {
        ...
        /* Si el triangulo tiene los tres lados iguales, entonces es un triangulo
        equilatero:*/
        if (lado1 == lado2 && lado1 == lado3) {
            // la formula para calcular el area de un triangulo equilatero es:
            a = (Math.sqrt(3) / 4) * lado1;// como todos los lados seran iguales no importa cual lado se tome
        ...
        // si el lado 1 es igual al lado 3 entonces es un triangulo escaleno
            ...
            return a;
        } else// Sino significa que el tringulo tiene solo dos lado iguales, y seria un
              // trianguilo isósceles
        {
            /*
             * La formula para calcular el area de un triangulo isoceles es:
             * A = ( b * √(a^2 - (2^2 / 4)) ) / 2
             */
            a = (lado2 * Math.sqrt(Math.pow(3, 2) - (Math.pow(2, 2) / 4))) / 2;
